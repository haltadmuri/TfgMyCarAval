...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (TfgMyCarAval.Logic.ShoppingCartActions myCartOrders = new TfgMyCarAval.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
            // Log the exception.
            TfgMyCarAval.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
